...
class Auralayer {
	...
	initialize_interface() {
		...
		this.HeaderRowLeft = createNewElement({
			type: "div",
 classes: ["HeaderRowLeft", "col-auto", "col-md-4", "d-flex", "align-content-center", ],
...
this.HeaderRowCenter = createNewElement({ type: "div", classes: [ "HeaderRowCenter", "col-auto", "col-md-4", "text-center", "d-flex", "align-content-center", ], parent: this.HeaderRow, properties: { id: "page-header" }, });
		this.HeaderRowRight = createNewElement({
			type: "div",
classes: ["HeaderRowRight","col-auto","col-md-4","d-flex","justify-content-end","align-content-center",],
			parent: this.HeaderRow,
		...
		this.UndoButton = createNewElement({
			type: "button",
			classes: ["UndoButton", "btn", "btn-outline-secondary", "border-0"],
		...
		this.RedoButton = createNewElement({
			type: "button",
			classes: ["RedoButton", "btn", "btn-outline-secondary", "border-0"],
			parent: this.UndoButtonGroup,
			properties: {
				innerText: "Redo",
				type: "button",
